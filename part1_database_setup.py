"""
Part 1: Database Setup for Multi-Agent Customer Service System
This script creates the SQLite database with customers and tickets tables
Based on the provided database_setup.py specification
"""
